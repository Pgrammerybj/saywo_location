package com.chat.saywo_location;
 ...
 * SaywoLocationPlugin
 */
public class SaywoLocationPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "saywo_location");
